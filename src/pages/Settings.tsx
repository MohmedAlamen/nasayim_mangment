...
import { Globe, Moon, Sun, Bell, Shield, Building, User } from 'lucide-react';
        ...
        <div className="p-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-medium">{dir === 'rtl' ? 'شركة مكافحة الحشرات' : 'Pest Control Co.'}</p>
            </div>
            <div>
              <Label className="text-muted-foreground text-sm">
            ...
            <div>
              ...
              <p className="font-medium" dir="ltr">+966 11 123 4567</p>
            </div>
            <div>
              <Label className="text-muted-foreground text-sm">
                {dir === 'rtl' ? 'العنوان' : 'Address'}
              </Label>
              <p className="font-medium">{dir === 'rtl' ? 'الرياض، المملكة العربية السعودية' : 'Riyadh, Saudi Arabia'}</p>
            </div>
          </div>
          <Button variant="outline" className="mt-4">
            {dir === 'rtl' ? 'تعديل البيانات' : 'Edit Information'}
          </Button>
        </div>
      </div>
    </div>
